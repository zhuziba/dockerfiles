...
if [ ! -e '/usr/share/v2ray/v2ray' ]; then
    if [ $(arch) == aarch64 ]; then      wget -O /tmp/v2ray/v2ray.zip https://hub.gitmirror.com/https://github.com/v2fly/v2ray-core/releases/download/v5.4.1/v2ray-linux-arm64-v8a.zip; fi
    if [ $(arch) == x86_64 ]; then     wget -O /tmp/v2ray/v2ray.zip https://hub.gitmirror.com/https://github.com/v2fly/v2ray-core/releases/download/v5.4.1/v2ray-linux-64.zip; fi
    if [ $(arch) == armv7l ]; then     wget -O /tmp/v2ray/v2ray.zip https://hub.gitmirror.com/https://github.com/v2fly/v2ray-core/releases/download/v5.4.1/v2ray-linux-arm32-v7a.zip; fi
